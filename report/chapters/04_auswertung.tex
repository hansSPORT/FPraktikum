...
\begin{align}
    B_c(0) &= (2758 \pm 171)~\mathrm{mT}, \label{eq:fit_bc0} \\
    T_c     &= (6{,}861 \pm 0{,}039)~\mathrm{K}. \label{eq:fit_tc}
\end{align}
...
\begin{figure}[htbp]
    ...
    Rote Kurve: parabolischer Fit~\eqref{eq:bc_parabola} mit $B_c(0) = 2758~\mathrm{mT}$, $T_c = 6{,}861~\mathrm{K}$.
